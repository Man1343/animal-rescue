...
const Shelter = () => {
    ...
    useEffect(()=>{
        axios.get(Constant.URLs.ApiUrl + '/Shelter').then((res)=>{
    ...
    const rowStyle = {
      ...
      const handleDelete = (unique_id) => {
        axios.delete(Constant.URLs.ApiUrl +`/deleteshelter/${unique_id}`)
          .then(response => {
  ...
  return (
    ...
    <center>
        ...
        <tr style={rowStyle}>
        <th className='emer'>Unique_Id</th>
            <th className='emer'> Name</th>
            <th className='emer'>Email</th>
            <th className='emer'>Mobile_No</th>
            <th className='emer'>Shelter Address</th>
            <th className='emer'>Manage</th>
        </tr>
        {
        mydata.map((user)=>{
            return (
                <tr style={rowStyle}>
                    ...
                    <td className='emer'>
                        <td>
                            <Link to = {`/Updateshelter`} className = "btn btn-outline-success">Update</Link>
                        </td>
